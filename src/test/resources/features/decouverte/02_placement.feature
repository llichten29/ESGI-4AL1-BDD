Feature: Placement des dominos
    ...
    Rule: Un domino se connecte au chateau (joker) ou a un terrain identique
    ...
    Rule: Un domino jouable doit etre pose, sinon il est defausse
    ...
    Rule: Une tentative de placement invalide est refusee
