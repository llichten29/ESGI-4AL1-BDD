Feature: Bonus optionnels (Empire du Feu et Homo Habilis)
    ...
    Rule: Empire du Feu rapporte 10 points si la hutte est entouree sur ses 4 cotes
    ...
    Rule: Homo Habilis rapporte 5 points si le territoire est complet (25 cases)
    ...
    Rule: Les bonus se cumulent entre eux et avec le score des regions
