Feature: Scoring des territoires
    ...
    Rule: Une region rapporte sa taille multipliee par son nombre d'icones Feu
    ...
    Rule: Les egalites sont departagees par la plus grande region puis par les feux
